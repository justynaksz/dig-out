...
public class AppUserMapper extends Mapper<AppUser, AppUserDTO> {
    ...
    public AppUser toModel(AppUserDTO appUserDTO) {
        ...
        if (appUserDTO.getGraveOwner() != null) {
            graveOwner = graveOwnerMapper.toModel(appUserDTO.getGraveOwner());
        }
    ...
    public AppUserDTO toDTO(AppUser appUser) {
        ...
        if (appUser.getGraveOwner() != null) {
            graveOwner = graveOwnerMapper.toDTO(appUser.getGraveOwner());
        }
